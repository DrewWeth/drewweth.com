...
, mSecondPassTextures()
{
	mShaders.load(Shaders::BrightnessPass, resourcePath()+  "Fullpass.vert", resourcePath()+"Brightness.frag");
	mShaders.load(Shaders::DownSamplePass, resourcePath()+  "Fullpass.vert", resourcePath()+"DownSample.frag");
	mShaders.load(Shaders::GaussianBlurPass, resourcePath()+"Fullpass.vert", resourcePath()+"GuassianBlur.frag");
	mShaders.load(Shaders::AddPass,          resourcePath()+"Fullpass.vert", resourcePath()+"Add.frag");
}
