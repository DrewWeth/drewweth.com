...
{
	mTextures.load(Textures::Entities, resourcePath()+"Entities.png");
	mTextures.load(Textures::Jungle, resourcePath()+"Jungle.png");
	mTextures.load(Textures::Explosion, resourcePath()+"Explosion.png");
	mTextures.load(Textures::Particle, resourcePath()+"Particle.png");
	mTextures.load(Textures::FinishLine, resourcePath()+"FinishLine.png");
}
